...
public class FixedLengthSeverHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        ctx.write(Unpooled.copiedBuffer(FixedLengthSever.resStr.getBytes(CharsetUtil.UTF_8)));//直接将数据应答回去
